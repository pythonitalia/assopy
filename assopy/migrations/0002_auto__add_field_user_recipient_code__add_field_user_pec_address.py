...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.recipient_code'
        db.add_column(u'assopy_user', 'recipient_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=7, blank=True),
                      keep_default=False)

        # Adding field 'User.pec_address'
        db.add_column(u'assopy_user', 'pec_address',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.recipient_code'
        db.delete_column(u'assopy_user', 'recipient_code')

        # Deleting field 'User.pec_address'
        db.delete_column(u'assopy_user', 'pec_address')
