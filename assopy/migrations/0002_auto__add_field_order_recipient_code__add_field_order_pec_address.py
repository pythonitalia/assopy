...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.recipient_code'
        db.add_column(u'assopy_order', 'recipient_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=7, blank=True),
                      keep_default=False)

        # Adding field 'Order.pec_address'
        db.add_column(u'assopy_order', 'pec_address',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.recipient_code'
        db.delete_column(u'assopy_order', 'recipient_code')

        # Deleting field 'Order.pec_address'
        db.delete_column(u'assopy_order', 'pec_address')
    ...
    models = {
        ...
        u'assopy.order': {
            ...
            'pec_address': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'blank': 'True'}),
            'recipient_code': ('django.db.models.fields.CharField', [], {'max_length': '7', 'blank': 'True'}),
        ...
        u'conference.conference': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'refund_end': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'refund_start': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
